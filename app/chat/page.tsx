...
export default function ChatPage() {
 ...
 // 🧠 Safe message sender (prevents double send)
...
>
  ...
  />
      ...
      <div className="flex-1 flex flex-col w-full">
        ...
        <div className="flex-1 flex flex-col relative px-2 sm:px-4 md:px-6">
          {messages.length === 0 ? (
            <div className="flex flex-col items-center justify-center text-center flex-1 px-2 sm:px-4">
              ...
              <div className="flex items-center gap-2 sm:gap-3 border border-gray-300 dark:border-gray-700 rounded-xl px-3 sm:px-4 md:px-5 py-2 sm:py-3 bg-transparent w-full max-w-[95%] sm:max-w-[700px] md:max-w-[950px] mx-auto">
                <input
                  type="text"
                  value={inputValue}
            ...
            <>
              ...
              <div className="sticky bottom-0 w-full border-t border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 p-2 sm:p-4 flex items-center gap-2 sm:gap-3">
                <input
                  type="text"
                  value={inputValue}
                  onChange={(e) => setInputValue(e.target.value)}
